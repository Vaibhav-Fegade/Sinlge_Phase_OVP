...
unsigned int FaultCheckDelay,ScrollTime,MessageTime;
...
void FaultChecking(void)
{
	...
	if(DispVolt && (DispVolt <= SetUnderVolt) && (Fault == NO_FAULT))
	{
		if(UnderVoltTime == 0)
		{
...
void DownKey(void)
{
	...
	{
		if(SetOverVolt > (SetUnderVolt + 20))	SetOverVolt--;
	}
	else if(CalPara == SET_UNDER_VOLT)
 	{
